...
#include "my_robot_pkg/msg/detail/motor_feedback__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const my_robot_pkg::msg::MotorFeedback *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_robot_pkg::msg::MotorFeedback *>(
    untyped_ros_message);
...
{
  return &my_robot_pkg::msg::typesupport_fastrtps_cpp::_MotorFeedback__handle;
}
