...
#include "my_robot_pkg/msg/detail/imu__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_robot_pkg::msg::Imu;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_robot_pkg::msg::Imu *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_robot_pkg::msg::Imu *>(
    untyped_ros_message);
...
{
  return &my_robot_pkg::msg::typesupport_fastrtps_cpp::_Imu__handle;
}
