...
{
  new (message_memory) my_robot_pkg::msg::MotorFeedback(_init);
}

void MotorFeedback_fini_function(void * message_memory)
{
  auto typed_message = static_cast<my_robot_pkg::msg::MotorFeedback *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MotorFeedback_message_members = {
  ...
  3,  // number of fields
  sizeof(my_robot_pkg::msg::MotorFeedback),
...
{
  return &::my_robot_pkg::msg::rosidl_typesupport_introspection_cpp::MotorFeedback_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_robot_pkg, msg, MotorFeedback)() {
  return &::my_robot_pkg::msg::rosidl_typesupport_introspection_cpp::MotorFeedback_message_type_support_handle;
}
