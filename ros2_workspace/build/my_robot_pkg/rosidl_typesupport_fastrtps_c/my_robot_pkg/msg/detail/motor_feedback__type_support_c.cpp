...
#include "my_robot_pkg/msg/detail/motor_feedback__rosidl_typesupport_fastrtps_c.h"
...
using _MotorFeedback__ros_msg_type = my_robot_pkg__msg__MotorFeedback;
...
static uint32_t _MotorFeedback__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_robot_pkg__msg__MotorFeedback(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_robot_pkg__msg__MotorFeedback;
    is_plain =
      (
...
static size_t _MotorFeedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_robot_pkg__msg__MotorFeedback(
