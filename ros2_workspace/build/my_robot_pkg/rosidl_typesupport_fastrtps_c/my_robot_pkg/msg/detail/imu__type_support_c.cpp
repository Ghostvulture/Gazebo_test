...
#include "my_robot_pkg/msg/detail/imu__rosidl_typesupport_fastrtps_c.h"
...
using _Imu__ros_msg_type = my_robot_pkg__msg__Imu;
...
static uint32_t _Imu__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_robot_pkg__msg__Imu(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_robot_pkg__msg__Imu;
    is_plain =
      (
...
static size_t _Imu__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_robot_pkg__msg__Imu(
